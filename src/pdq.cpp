...
void pdq() {
    ...
    // =========================================================================
    t_start = Clock::now();
    auto ctxt_index_trace = ringswitch(context_trace, keypair_trace.publicKey, switch_key, ctxt_index);
    auto ctxt_masked_trace = ringswitch(context_trace, keypair_trace.publicKey, switch_key, ctxt_masked);
    t_end = Clock::now();
